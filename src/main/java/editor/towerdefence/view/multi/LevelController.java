...
//        children.add(lastIndex, vbox);
    ...
    @FXML
    private void handleLevelApplyButtonClick(ActionEvent event) {
    ...
    private void changeText(){
        ...
        roadTexture.setText(level.getRoadTextureName());
        roadTexture.setText(level.getBackgroundTextureName());
        roadTexture.setText(level.getPlotTextureName());
        levelMap.setText(String.valueOf(level.getMapID()));
        levelEnemySpeed.setText("0");
        levelEnemyDamage.setText("0");
        levelEnemyHealth.setText("0");
    }
}